# Workout Fluency Registry — Specification v0.2.22
...
## 7. Schema: required fields per variant (v0.2.22)
...
## 10. Acceptance criteria (v0.2.22 doc + KB pilot)
...
## 11. Acceptance criteria (wiring phase — beyond v0.2.22 KB)
...
*End of v0.2.22 — Pilot 1 threshold **9** **`approved`**; Pilot 2 long **9** **`approved`**; Pilot 3 easy **6** **`approved`**; Pilot 4 intervals **12** **`approved`** (3 advanced ids KB-only until scaler); Pilot 5 repetitions **2** **`approved`**; **deferred:** long sustained VO2 hill-repeat progressions per §9; **Phase 2:** `workout_registry.json` + `test_workout_registry.py` (revision **0.2.23**); product voice is StrideIQ synthesis, not third-party bibliography.*
