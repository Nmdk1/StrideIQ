...
**Last updated:** April 4, 2026 (Coach prompt quality fix, Limiter Phase 5 transition detection, cross-training phases 1-5, Runtoon fix, route cleanup, page merges, wellness surfaces, Manual V2, nav consolidation, repo cleanup)
