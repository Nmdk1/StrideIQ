...
**Last updated by:** Builder session — AutoDiscovery Phase 0A + 0B + 0C (founder review + controlled promotion staging); Coach Model Routing Reset (Sonnet 4.6, Gemini thought_signature fix)
