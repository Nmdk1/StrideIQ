...
**Last updated by:** Builder session — Progress Narrative: visual-first five-act progress page replacing 12-card layout
...
# Progress Narrative
apps/api/routers/progress.py                ← GET /v1/progress/narrative + POST /v1/progress/narrative/feedback
apps/api/tests/test_progress_narrative.py   ← 14 tests: shape, fallback, suppression, N=1 gating, caching
apps/web/app/progress/page.tsx              ← Five-act visual-first narrative page
apps/web/components/progress/               ← 8 visual components (sparkline, bar, gauge, etc.)
apps/web/lib/hooks/queries/progress.ts      ← useProgressNarrative + useNarrativeFeedback hooks
