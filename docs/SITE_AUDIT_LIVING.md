...
**Last updated by:** Builder session — AutoDiscovery Phase 0A + 0B (shadow scoring, interaction loop, pilot tuning loop); Coach Model Routing Reset (Sonnet 4.6, Gemini thought_signature fix)
