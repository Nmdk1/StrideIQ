...
| 11 | Coach LLM Upgrade (Multi-Model Tiering) | **In progress** | GPT-4o-mini default with Opus for high-stakes/VIP routing. Training pace tool added. See `docs/LLM_MODEL_RESEARCH.md`. |
