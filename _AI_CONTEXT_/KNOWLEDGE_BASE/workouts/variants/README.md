...
**Spec:** [`docs/specs/WORKOUT_FLUENCY_REGISTRY_SPEC.md`](../../../../docs/specs/WORKOUT_FLUENCY_REGISTRY_SPEC.md) (v0.2.16)
...
| [`easy_pilot_v1.md`](easy_pilot_v1.md) | Pilot 3 — easy / recovery / easy_strides / rest | **4 variants `sme_status: approved`** (founder 2026-03-20) |
...
- Pilots **1–3** (threshold, long-family, easy-family) rows are **`approved`** (see respective pilot files). **VO2** and any other **v1** tracks remain **`draft`** or not started until approved. **Phase 3 wiring** waits on **all v1-scoped** pilots per `WORKOUT_FLUENCY_BUILD_SEQUENCE.md`. Runtime wiring still follows spec §2 (P0 gate).
