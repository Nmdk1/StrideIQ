...
**Purpose:** One place to see which **`workout_type`** strings the **plan generator + scaler** can schedule, and which **pilot file** owns variant prose. Update when `generator.py` or `workout_scaler.py` adds a new primary type.
