#!/usr/bin/env python3
"""Test RPI lookup system accuracy."""
import sys
...
def test_rpi_calculation():
    ...
    print("=" * 60)
    print("RPI LOOKUP SYSTEM TEST")
    print("=" * 60)
    
    test_cases = [
        {"distance_m": 5000, "time_s": 1200, "expected_rpi": 50.0, "desc": "5K in 20:00"},
        {"distance_m": 10000, "time_s": 2400, "expected_rpi": 50.0, "desc": "10K in 40:00"},
        {"distance_m": 5000, "time_s": 1080, "expected_rpi": 55.0, "desc": "5K in 18:00"},
        {"distance_m": 5000, "time_s": 900, "expected_rpi": 60.0, "desc": "5K in 15:00"},
    ]
    ...
    for test in test_cases:
        calculated = calculate_rpi_from_race_time_lookup(
            test["distance_m"], 
            test["time_s"]
        )
        ...
        # Get training paces
        if calculated:
            paces = get_training_paces_from_rpi(calculated)
            if paces:
