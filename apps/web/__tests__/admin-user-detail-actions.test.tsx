...
jest.mock('@/lib/hooks/queries/admin', () => ({
  ...
  useCompAccess: () => ({ mutate: mutateComp, isPending: false, isSuccess: false, isError: false, error: null }),
  ...
  useSetCoachVip: () => ({ mutate: jest.fn(), isPending: false, isSuccess: false, isError: false, error: null }),
