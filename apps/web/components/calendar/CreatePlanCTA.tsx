...
export function CreatePlanCTA() {
  return (
    <div className="bg-gradient-to-br from-slate-800/80 to-slate-900 border border-slate-700/50 rounded-xl p-8 text-center">
      {/* Icon */}
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link
          href="/plans/preview"
          className="px-6 py-3 bg-slate-800 border border-slate-600 hover:border-slate-500 rounded-lg font-medium text-slate-300 hover:text-white transition-colors"
        >
          Preview Plans
        </Link>
      </div>
      ...
      {/* Tiers info */}
      <div className="mt-8 pt-6 border-t border-slate-700/50/50">
        <div className="flex flex-wrap justify-center gap-6 text-sm">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
            <span className="text-slate-400">Standard Plans</span>
            <span className="text-emerald-400 font-semibold">Free</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-blue-500"></span>
            <span className="text-slate-400">Semi-Custom</span>
            <span className="text-blue-400 font-semibold">$5</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-purple-500"></span>
            <span className="text-slate-400">Full Custom</span>
