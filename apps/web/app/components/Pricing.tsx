...
export default function Pricing() {
  return (
    <section id="pricing" className="py-20 bg-gray-800 scroll-mt-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="w-full">
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <Link href="/register" className="block w-full bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-lg transition-colors text-sm text-center">
              Get Started
            </Link>
          </div>
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-xs text-gray-500 mb-4">One-time purchase</p>
            <ul className="space-y-2 text-sm text-gray-400 mb-6">
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-xs text-gray-500 mb-4">One-time • Race-targeted</p>
            <ul className="space-y-2 text-sm text-gray-400 mb-6">
          ...
          <div className="bg-gradient-to-br from-orange-900/40 to-gray-900 rounded-lg p-6 border-2 border-orange-500 relative md:shadow-xl md:shadow-orange-500/20">
        ...
        <div className="mt-8 w-full">
          <div className="bg-gradient-to-r from-orange-900/30 to-gray-900 rounded-lg p-6 border border-orange-500/50">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
              <div>
                <h3 className="text-2xl font-bold mb-1">Why Guided Self-Coaching?</h3>
                <p className="text-sm text-gray-400">Elite-level guidance, accessible to everyone</p>
              </div>
              <a
                href="#tools"
