    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <blockquote className="text-xl md:text-2xl italic mb-8 text-gray-300 max-w-3xl mx-auto border-l-4 border-orange-500 pl-6">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-12">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-300">The Mission</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-300">The Stance</h3>
                <p className="text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-gray-300">Guided Self-Coaching</h3>
                <p className="text-gray-300 leading-relaxed">
